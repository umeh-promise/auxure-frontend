...
const Home = () => {
  ...
  return (
    <main id='home'>
      ...
      {showButton && (
        <aside
          className='z-[999] fixed flex items-center justify-center bg-primary hover:bg-accent-1 px-[1rem] py-[1.2rem] right-[10rem] bottom-[10rem] cursor-pointer rounded-[0.15rem] opacity-[0.75] hover:opacity-[1] transition-all duration-300'
